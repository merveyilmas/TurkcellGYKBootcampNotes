...
# çoğunlukla sınıflandırma ve regresyon kullandığımız problemlerde kullanırız
# veri noktaları arasındaki en iyi ayrımı anlamamızı sağlar
...
# bana veri oluştur, 50 örnek - 2 grup oluştur
